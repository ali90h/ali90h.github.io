...
let isCalm = localStorage.getItem("calm") === "true";
setCalm(isCalm);
...
window.addEventListener("keydown", (e) => {
  if (e.key === "Escape") { document.getElementById("help")?.classList.remove("active"); return; }
  ...
  if (e.key === "c"||e.key==="C") { isCalm = !isCalm; setCalm(isCalm); return; }
